function [z,y,x] = R2zyx(R_AB)
% R2zyx 3 angles about new axes in the zyx order are found from a rotation matrix. 
%   [z,y,x] = R2zyx(R_AB) 
...
if cos_y > n_of_eps_to_define_singularity*eps
    ...
    y = -sign(R_AB(3,1))*pi/2; % Selecting y = +-pi/2, with correct sign
